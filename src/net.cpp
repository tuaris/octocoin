...
static const char *strMainNetDNSSeed[][2] = {
	{"octocoin.org", "s1.octocoin.org"},
	{"octocoin.org", "s2.octocoin.org"},
	{"fusionhash.com", "sfo.fusionhash.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. OctoCoin is probably already running."), addrBind.ToString().c_str());
        else
