...
def initialize_chain(test_dir):
    ...
    4 wallets.
    octocoind and bitcoin-cli must be in search path.
    """
    ...
    for i in range(4):
        ...
        initialize_datadir(test_dir, i) # Overwrite port/rpcport in octocoin.conf
...
def start_node(i, dirname, extra_args=None, rpchost=None):
    """
    Start a octocoind and return RPC connection to it
    """
