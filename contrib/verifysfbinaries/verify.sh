...
###   This script attempts to download the signature file SHA256SUMS.asc from octocoin.org
...
SIGNATUREFILE="https://octocoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://octocoin.org/bin/"
...
if [ $? -ne 0 ]; then
   ...
   echo "[octocoin-]<version>-[rc[0-9]] (example: octocoin-0.9.2-rc1)"
   echo "wget output:"
