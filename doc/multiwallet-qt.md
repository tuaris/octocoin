...
In order to support loading of multiple wallets in octocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is octocoin.cpp.

Finally, two new headers and source files will have to be added to octocoin-qt.pro.
...
Changes to octocoin.cpp
----------------------
octocoin.cpp is the entry point into octocoin-qt, and as such, will require some minor modifications to provide hooks for
