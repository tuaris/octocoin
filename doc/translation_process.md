...
The Octocoin Core GUI can be easily translated into other languages. Here's how we
...
https://www.transifex.com/projects/p/octocoin/resource/tx/
...
2. update `src/qt/octocoin.qrc` manually or via
