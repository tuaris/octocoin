Octocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/octocoin/files/Octocoin/octocoin-0.5.4/
...
http://gitorious.org/octocoin/octocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Octocoin-Qt notifications under Growl 1.3.
Increase required age of Octocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Octocoin-Qt over it. (Windows)
