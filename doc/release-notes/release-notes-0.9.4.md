Octocoin Core version 0.9.4 is now available from:

  https://octocoin.org/bin/0.9.4/
...
this update is incompatible with the Octocoin system and could lead to consensus
forks.

Octocoin Core released binaries from https://octocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~octocoin/+archive/ubuntu/octocoin
- A third-party or self-compiled Octocoin Core

upgrade to Octocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
