Octocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/octocoin/files/Octocoin/octocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Octocoin
...
New/changed settings (command-line or octocoin.conf file)
--------------------------------------------------------
