The following is a list of assets used in the octocoin source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original octocoin logo from Bitboy)
* License: MIT
